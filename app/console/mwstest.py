import requests, time, bottlenose, math, urllib
from bs4 import BeautifulSoup
from amazon_scraper import AmazonScraper # https://github.com/adamlwgriffiths/amazon_scraper
from decimal import Decimal
from categoriestest import *

# Amazon scraper + Amazon API wrapper
amazon = AmazonScraper('AKIAIZDRPWPDTNWW2YRA', '6i41Uyy1vFQqDrMpJkRCAoWtHRrZgMo+OULV3t3q', 'michaeljreiss', Region='UK')
	
# Access Raw Amazon XML Response
amazon_raw = bottlenose.Amazon('AKIAIZDRPWPDTNWW2YRA', '6i41Uyy1vFQqDrMpJkRCAoWtHRrZgMo+OULV3t3q','michaeljreiss', Region='UK')

p = amazon.lookup(ItemId='0085715731005', IdType='EAN', ResponseGroup='Large', SearchIndex="All")
raw_data = amazon_raw.ItemLookup(ItemId='5050456102136', IdType='EAN', ResponseGroup="Large", SearchIndex="All")
